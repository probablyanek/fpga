## Generated SDC file "expt9.out.sdc"
...
create_clock -name {clk} -period 9.450 -waveform { 0.000 5.000 } [get_ports {clk}]
...
set_output_delay -add_delay  -clock [get_clocks {clk}] 1.000 [get_ports {Y}]
